...
def tabla_usuarios():
    ...
    if cursorBD.fetchone()[0] == 1:
        ...
        cursorBD.execute(
            """CREATE TABLE usuarios (id integer primary key autoincrement,id_discord integer unique, username text, display_name text, avatar text, coins integer) """
        )
        return False
...
preguntas =[
  ...
  {"pregunta": "¿Qué electrodoméstico consume más energía en casa?", "respuesta": "aire acondicionado", "ganancia": 90, "perdida": -45},
  {"pregunta": "¿Qué animal está en peligro por el plástico en el mar: tortuga o gallina?", "respuesta": "tortuga", "ganancia": 80, "perdida": -40},
  {"pregunta": "¿Cuál es el material más fácil de reciclar?", "respuesta": "aluminio", "ganancia": 65, "perdida": -32},
  ...
  {"pregunta": "¿Qué se usa para medir la calidad del aire?", "respuesta": "índice de calidad del aire", "ganancia": 90, "perdida": -45},
  ...
  {"pregunta": "¿Qué hacemos al reciclar papel?", "respuesta": "salvamos árboles", "ganancia": 95, "perdida": -47},
  ...
  {"pregunta": "¿Qué debemos hacer para proteger los bosques?", "respuesta": "no talar árboles", "ganancia": 90, "perdida": -45},
  ...
  {"pregunta": "¿Qué país genera más residuos por persona?", "respuesta": "EE.UU.", "ganancia": 85, "perdida": -42},
  ...
  {"pregunta": "¿Qué tipo de pila contamina más?", "respuesta": "pilas de mercurio", "ganancia": 80, "perdida": -40},
